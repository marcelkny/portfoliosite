...
<body>
    <div class="bg_div">
        ...
        <main>
                    ...
                    <div class="portfolio_card" id="language_card">
                        ...
                        <div class="codinglanguagecontainers">
                            <div class="codinglanguagecontainer">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 1024 1024" height="35" width="35" xmlns="http://www.w3.org/2000/svg">
                            ...
                            <div class="codinglanguagecontainer">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" height="35" width="35" xmlns="http://www.w3.org/2000/svg">
                                    <title></title>
                            ...
                            <div class="codinglanguagecontainer">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" height="35" width="35" xmlns="http://www.w3.org/2000/svg">
                        ...
                        <div class="codinglanguagecontainers">
                            ...
                            <div class="codinglanguagecontainer">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" height="35" width="35" xmlns="http://www.w3.org/2000/svg">
                                    <title></title>
                                    <path d="M24 9.533L21.374 0 11.57 2.555l-1.45 2.49-2.945-.022L0 12l7.176 6.978 2.943-.023 1.454 2.49 9.8 2.554L24 14.47 22.508 12 24 9.533zM10.356 5.445l7.499-1.874-4.304 7.251H4.94l5.416-5.377zm0 13.11L4.94 13.18h8.61l4.305 7.251-7.5-1.874zm9.598.696l-4.307-7.25 4.307-7.253L22.033 12l-2.08 7.25z"></path>
                                </svg>
                                <p>Unity</p>
                            </div>
                            <div class="codinglanguagecontainer">
                        ...
                        <div class="codinglanguagecontainers">
                            ...
                            <div class="codinglanguagecontainer">
                                <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="35" width="35" xmlns="http://www.w3.org/2000/svg">
            ...
            <div class="section" id="portfolio">
                ...
                <div class="sectioncontent" id="portfoliosectioncontent">
                </div>
            </div>
            <hr class="myhr">
            <div class="section" id="kontakt">
                ...
                <a class="footer_a" href="mailto:kontakt@knymarcel.de" rel="noreferrer">
                    <svg class="footer_svg" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="270" width="270" xmlns="http://www.w3.org/2000/svg">
        ...
        <footer>
            <div id="navbar_bottom">
                <div class="bottom_nav_item">
                    <a class="footer_a" href="mailto:kontakt@knymarcel.de" rel="noreferrer">
                        <svg class="footer_svg" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="27" width="27" xmlns="http://www.w3.org/2000/svg">
                            <path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm2-1a1 1 0 0 0-1 1v.217l7 4.2 7-4.2V4a1 1 0 0 0-1-1H2zm13 2.383-4.758 2.855L15 11.114v-5.73zm-.034 6.878L9.271 8.82 8 9.583 6.728 8.82l-5.694 3.44A1 1 0 0 0 2 13h12a1 1 0 0 0 .966-.739zM1 11.114l4.758-2.876L1 5.383v5.73z"></path>
                        </svg>
                    </a>
                    <a class="footer_a" href="https://github.com/marcelkny" target="_blank" rel="noopener noreferrer">
                        <svg class="footer_svg" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 16 16" height="24" width="24" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <a class="footer_a" href="https://www.linkedin.com/in/marcel-kny-87b755226/" target="_blank" rel="noopener noreferrer">
                        <svg class="footer_svg" stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" height="27" width="27" xmlns="http://www.w3.org/2000/svg">
    ...
    <script src="inc/js/portfoliocards.js"></script>
    </div>
</body>
